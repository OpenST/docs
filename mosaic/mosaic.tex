...
Also note that, in normal operation, the probability of this happening can be made very small.
It is a matter of balancing safety and usability.

Under the unlikely scenario that origin reverts history, the meta-blockchain must be forced to halt.
It should halt at the highest finalized checkpoint of the auxiliary system which was still consistent with its observation of the history of the origin blockchain before the revision.
